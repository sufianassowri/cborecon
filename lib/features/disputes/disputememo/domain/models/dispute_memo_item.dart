...
/// Enum defining the transaction scope for dispute calculations
enum DisputeType {
  onUs,
  remoteOnUs,
}
...
class DisputeMemoItem {
  ...
  /// - DisputeType.onUs: Always 0.5% (0.005) regardless of date
  /// - DisputeType.remoteOnUs (on/after May 22, 2026): 0.6% (0.006)
  /// - DisputeType.remoteOnUs (before May 22, 2026): 0.5% (0.005)
  double get pl62174 {
    double rate = 0.005;

    if (disputeType == DisputeType.remoteOnUs) {
